...
in {
  ...
  services.sketchybar.config = ''
    ...
    sketchybar --add event keyboard_input_source_change AppleSelectedInputSourcesChangedNotification

    sketchybar --add item clock right                                                     \
               --set clock update_freq=10 icon=  script="$PLUGIN_DIR/clock.sh"           \
                                                                                          \
               --add item keyboard right                                                  \
               --set keyboard icon=  script="$PLUGIN_DIR/kblayout.sh"                    \
               --subscribe keyboard keyboard_input_source_change                          \
                                                                                          \
